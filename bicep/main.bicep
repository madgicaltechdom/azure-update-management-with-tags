...
module Win01 'ModuleVM.bicep' = if (VmWindows_2019DC) {
  ...
  params:{
    ...
    tags_policy_update: 'Monday;07:15 PM;Always;*java*;'
  }
  dependsOn:[
    Lag
    Vnet
...
module Win02 'ModuleVM.bicep' = if (VmWindows_2016) {
  ...
  params:{
    ...
    adminUsername: adminUsername
    adminPassword: adminPassword
    tags_policy_update: 'Monday;07:15 PM;Always;;TeamA@abc.com'
  }
  dependsOn:[
    Lag
    Vnet
...
module Lnx01 'ModuleVM.bicep' = if (VmUbuntu_20_04) {
  ...
  params:{
    ...
    adminUsername: adminUsername
    adminPassword: adminPassword
    tags_policy_update: 'Monday;07:15 PM;Always;;'
  }
  dependsOn:[
    Lag
    Vnet
...
module Lnx02 'ModuleVM.bicep' = if (VmUbuntu_18_04) {
  ...
  params:{
    ...
    adminUsername: adminUsername
    adminPassword: adminPassword
    tags_policy_update: 'Monday;07:15 PM;Always;*java*,*oracle*;TeamB@abc.com'
  }
  dependsOn:[
    Lag
    Vnet
