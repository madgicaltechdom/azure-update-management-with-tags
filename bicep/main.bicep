...
module Win01 'ModuleVM.bicep' = if (VmWindows_2019DC) {
  ...
  params:{
    ...
    tags_policy_update: 'Tuesday;04:30 PM;Always;*java*;'
  }
  dependsOn:[
    Lag
    Vnet
...
module Win02 'ModuleVM.bicep' = if (VmWindows_2016) {
  ...
  params:{
    ...
    adminUsername: adminUsername
    adminPassword: adminPassword
    tags_policy_update: 'Tuesday;04:31 PM;Always;;TeamA@abc.com'
  }
  dependsOn:[
    Lag
    Vnet
...
module Win03 'ModuleVM.bicep' = if (VmWindows_2012R2) {
  ...
  params:{
    ...
    adminUsername: adminUsername
    adminPassword: adminPassword
    tags_policy_update: 'Tuesday;04:32 PM;Always;*java*;'
  }
  dependsOn:[
    Lag
    Vnet
...
module Lnx01 'ModuleVM.bicep' = if (VmUbuntu_20_04) {
  ...
  params:{
    ...
    adminUsername: adminUsername
    adminPassword: adminPassword
    tags_policy_update: 'Tuesday;04:33 PM;Always;;'
  }
  dependsOn:[
    Lag
    Vnet
...
module Lnx02 'ModuleVM.bicep' = if (VmUbuntu_18_04) {
  ...
  params:{
    ...
    adminUsername: adminUsername
    adminPassword: adminPassword
    tags_policy_update: 'Tuesday;04:34 PM;Always;*java*,*oracle*;TeamB@abc.com'
  }
  dependsOn:[
    Lag
    Vnet
...
module Lnx03 'ModuleVM.bicep' = if (VmCentOS_7_4) {
  ...
  params:{
    ...
    adminUsername: adminUsername
    adminPassword: adminPassword
    tags_policy_update: 'Tuesday;04:35 PM;Always;*java*,*oracle*;TeamB@abc.com'
  }
  dependsOn:[
    Lag
    Vnet
